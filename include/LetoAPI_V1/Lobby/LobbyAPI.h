...
#ifndef INC_LETO_API_V1_LOBBY_LOBBY_API_H_
#define INC_LETO_API_V1_LOBBY_LOBBY_API_H_
...
struct LobbyAPI_V1
{
	 ...
	 */
	uint32_t (*const GetLobbiesNear) (struct LobbyInfo_V1* info, uint32_t available);
     ...
     */
    bool (*const CreateLobby)(struct LobbyConnection_V1* lobby, uint16_t app_id, uint8_t max_count, LobbyConnection_V1_Callback callback);
     ...
     */
    void (*const JoinLobby)(struct LobbyInfo_V1 info, LobbyConnection_V1_Callback callback);
     ...
     */
    bool (*const GetActiveLobby)(struct LobbyConnection_V1* lobby);
